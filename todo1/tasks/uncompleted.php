...
<?php
      if(isset($_SESSION['user_id'])){
             ...
             $un_query = "SELECT * FROM task WHERE user_id = '".$user_id."' AND is_completed = 'no' ";
        ...
        if($count == 0){
           echo "<script type='text/javascript'>alert('No incompleted list here');
 ...
 ?> 
        <div class="form-group">
                <tr id="<?php echo $list_id; ?>">
                  ...
                  <td><a href="uncompleted.php?complete=<?php echo $list_id ?>"><input type="submit" style="float:right;" name="complete" value="complete" class="btn btn-primary"/></a></td>
